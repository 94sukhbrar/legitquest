...
return [
    ...
    'stateCodes' => [
        ...
        "SK2411" =>[ "state_cd"=>11,"dist_cd"=>1,"court_code"=>1],
        "KA312" =>  ["state_cd"=> 3,"dist_cd"=> 1,"court_code"=> 2],
        "KA313"=> ["state_cd"=>3, "dist_cd"=>1, "court_code"=>3],
        "KA311" =>["state_cd"=>3,"dist_cd"=>1, "court_code"=>1],
        "JH711"=> ["state_cd"=>"7", "dist_cd"=>1, "court_code"=>1],
        "MH115"=> ["state_cd"=>5, "dist_cd"=>1, "court_code"=>1],
        "AS611"=> ["state_cd"=>6, "dist_cd"=>1, "court_code"=>1],
        "DL1112"=> ["state_cd"=>91,"dist_cd"=>1, "court_code"=>1],
        "DL1111"=>  ["state_cd"=>90,"dist_cd"=>1,"court_code"=>1], 
        "WB1611"=> ["state_cd"=>16,"dist_cd"=>1,"court_code"=>1] ,
        "BB1117"=> ["state_cd"=>2, "dist_cd"=>1, "court_code"=>1],
        "BB1116"=> ["state_cd"=>2, "dist_cd"=>1, "court_code"=>1],
        "BB1115" => ["state_cd"=>2,"dist_cd"=>1,"court_code"=>1] , 
        "BB1114"=> ["state_cd"=>2,"dist_cd"=>1,"court_code"=>1],
        "BB1113"=>["state_cd"=>2,"dist_cd"=>1,"court_code"=>1] ,
        "BB1112"=> ["state_cd"=>2, "dist_cd"=>1, "court_code"=>1],
        "BB1111"=> ["state_cd"=>2,"dist_cd"=>1,"court_code"=>1] , 
     ],
    'stateList' => [
        "HIDO" => "Supreme Court ",
